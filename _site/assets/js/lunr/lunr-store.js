var store = [{
        ...
        "excerpt":"For anyone familiar with programming, it’s practically taboo to include anything resembling while(true) in one’s code. After a while, one might be pretty adept at spotting pitfalls like this when inspecting code. The shocking mathematical fact is that the problem of spotting all the ways in which some code may...","categories": ["Math","Programming","Computer Science"],
        "tags": ["Algorithms","Computability","Decidability"],
        "url": "/math/programming/computer%20science/2023/07/27/what-is-the-halting-problem.html",
        "teaser": null
      },{
